...
MENU = [ 
  ...
  ["À la une", {:controller => :accueil, 
                :action => :rss, 
                :hide => true,
                :description => "Écologie, Socialisme, République"}],
...
CATEGORIES = [
              ...
              ["VENDREDI DU PARTI", 'vendredi', {:searchable => true,
                                                 ...
                                                 :action => :vendredi,
                                                 :category_title => "LES VENDREDIS DU PARTI DE GAUCHE",
                                                 :link_all_title => "VOIR TOUS LES VENDREDIS"}],
              ["VIDÉO ÉDUC POP", 'videoeduc', {:searchable => true,
                                               :video => true,
                                               :controller => :educpop,
                                               :action_all => :videos,
                                               :action => :video,
