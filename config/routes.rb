...
PartiDeGauche::Application.routes.draw do
  ...
  get '/laradiodegauche' => 'podcast#laradiodegauche', :as => 'laradiodegauche'
  get '/laradiodegauche/educpop' => 'podcast#educpopall'
  get '/laradiodegauche/educpop/*uri(.:format)' => 'podcast#educpop'
  get '/laradiodegauche/radioactu' => 'podcast#radioactuall'
  get '/laradiodegauche/radioactu/*uri(.:format)' => 'podcast#radioactu'
  get '/laradiodegauche/intervention' => 'podcast#interventionall'
  get '/laradiodegauche/intervention/*uri(.:format)' => 'podcast#intervention'
  get '/laradiodegauche/radiomedia' => 'podcast#radiomediaall'
  get '/laradiodegauche/radiomedia/*uri(.:format)' => 'podcast#radiomedia'
  ...
  get '/laradiodegauche/all' => 'podcast#all'
  get '/podcast' => 'podcast#index'
