...
MENU = [
  ...
  ["Accueil", {:controller => '/podcast',
                       :action => :laradiodegauche,
                       :hide => true,
                       :hide_main_menu => true,
  ...
  ["Notre actu", {:controller => '/podcast',
                       :action => :radioactuall,
                       :hide => true,
                       :hide_main_menu => true,
                       :identity_layout => "radio",
                       :description => "Les Actualités Radio"}],
  ["Educ'Pop", {:controller => '/podcast',
                       :action => :educpopall,
                       :hide => true,
                       :hide_main_menu => true,
                       :identity_layout => "radio",
                       :description => "Educ'Pop"}],
  ["Médias", {:controller => '/podcast',
                       :action => :radiomediaall,
                       :hide => true,
                       :hide_main_menu => true,
                       :identity_layout => "radio",
                       :description => "Dans les médias"}],
  ["Interventions", {:controller => '/podcast',
                       :action => :interventionall,
                       :hide => true,
                       :hide_main_menu => true,
                       :identity_layout => "radio",
                       :description => "Interventions"}],
  ["Tous les sons", {:controller => '/podcast',
                       :action => :all,
                       :hide => true,
                       :hide_main_menu => true,
                       :identity_layout => "radio",
                       :description => "Tous les sons de la Radio de Gauche"}],
  ["Podcast de Gauche", {:controller => '/podcast',
                        :action => :rss,
                        :hide => true,
                        :identity_icon => "logo-radio-de-gauche-large.png",
